from asymctv.elements_to_orbit import orbital_elements_to_coordinates
from asymctv.elements_to_orbit import orbital_elements_to_coordinates_circular
...
def contact_times_to_delta_c_ingress(
    k_l, t1_l, t2_l, period, a_over_rs, ecc, omega, cosi, t0, rs_alpha=1
):
    cb_X_t1, cb_Y_t1 = orbital_elements_to_coordinates(
        t1_l, period, a_over_rs, ecc, omega, cosi, t0
    )
    cb_X_t2, cb_Y_t2 = orbital_elements_to_coordinates(
        t2_l, period, a_over_rs, ecc, omega, cosi, t0
    )
    dc_X_ingress, dc_Y_ingress = cb_to_delta_c_ingress(
        cb_X_t1, cb_Y_t1, cb_X_t2, cb_Y_t2, k_l, rs_alpha
    )
    return dc_X_ingress, dc_Y_ingress
...
def contact_times_to_delta_c_egress(
    k_l, t3_l, t4_l, period, a_over_rs, ecc, omega, cosi, t0, rs_alpha=1
):
    cb_X_t3, cb_Y_t3 = orbital_elements_to_coordinates(
        t3_l, period, a_over_rs, ecc, omega, cosi, t0
    )
    cb_X_t4, cb_Y_t4 = orbital_elements_to_coordinates(
        t4_l, period, a_over_rs, ecc, omega, cosi, t0
    )
    dc_X_egress, dc_Y_egress = cb_to_delta_c_egress(
        cb_X_t3, cb_Y_t3, cb_X_t4, cb_Y_t4, k_l, rs_alpha
    )
    return dc_X_egress, dc_Y_egress
...
def contact_times_to_delta_c_egress_circular(
    k_l, t3_l, t4_l, period, a_over_rs, cosi, t0, rs_alpha=1
):
    cb_X_t3, cb_Y_t3 = orbital_elements_to_coordinates(
        t3_l, period, a_over_rs, cosi, t0
    )
    cb_X_t4, cb_Y_t4 = orbital_elements_to_coordinates(
        t4_l, period, a_over_rs, cosi, t0
    )
    dc_X_egress, dc_Y_egress = cb_to_delta_c_egress(
        cb_X_t3, cb_Y_t3, cb_X_t4, cb_Y_t4, k_l, rs_alpha
    )
